...
import { PRESET_COMMAND_OPTIONS, getPresetCommandLabel } from './presets/commandOptions';
...
export const isBuiltinActionId = (id: string) => ACTION_DEFINITIONS.some(action => action.id === id);
