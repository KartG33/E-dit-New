import { listenKeyboardVisibility } from '../lib/keyboardOverlay';
...
export const capacitorAndroidAppBindings: AndroidAppBindings = {
  ...
  addKeyboardWillShowListener: listener => listenKeyboardVisibility(true, listener),
  addKeyboardWillHideListener: listener => listenKeyboardVisibility(false, listener),
